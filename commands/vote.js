...
module.exports = {
  ...
  execute(message, args, config) {
    ...
    message.author.send('Here is the link to the bot on DiscordBots.org. With your vote, the bot will become more and more popular and used by more servers. We appreciate it very much! -> https://discordbots.org/bot/571666138312867849/vote')
  }
}